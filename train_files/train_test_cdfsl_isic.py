...
class CustomDatasetFromImages(Dataset):
    def __init__(self, csv_path= ".../datasets_for_bscdfsl/ISIC2018_Task3_Training_GroundTruth.csv", \
        image_path =  ".../datasets_for_bscdfsl/ISIC2018_Task3_Training_Input/"):
        """
        Args:
...
def episode_loop():
    for idx, (x, y) in enumerate(novel_loader):
        ...
        support_set = support_set.reshape((support_set.shape[0] * support_set.shape[1]), 3, 450, 600).cuda() # [5,3,224,224] for 5 way-1 shot, [25, 3, 224, 224] for 5 way-5 shot
        query_set = query_set.reshape((query_set.shape[0] * query_set.shape[1]), 3, 450, 600).cuda() # [80, 3, 224, 224] for both settings
...
labels2classnames = {0: "Melanoma", 1: "Melanocytic Nevi", 2: "Basal Cell Carcinoma", 3: "Actinic Keratosis", 4: "Benign Keratosis", 5: "Dermatofibroma", 6: "Vascular Lesions"}
